...
namespace PIN_projekt.Controllers
{
    public class PetsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Ime,Starost,Pasmina,datumdodavanja")] Pets pets)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ime,Starost,Pasmina,datumdodavanja")] Pets pets)
        {
            if (id != pets.Id)
            {
                return NotFound();
